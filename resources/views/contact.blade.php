...
@section('content')
    ...
    <div class="min-h-screen pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-8 rounded-2xl overflow-hidden border border-white/10 h-64 relative group">
            ...
            <iframe src="https://maps.google.com/maps?q=Revo+Fitness+Manastur+Cluj&t=&z=15&ie=UTF8&iwloc=&output=embed"
    ...
    <div class="bg-brand-gray p-8 md:p-10 rounded-2xl border border-white/5 shadow-2xl" data-aos="fade-left">
        ...
        <form class="space-y-6" action="{{ route('contact.send') }}" method="POST">
            @csrf
            <div>
                <label for="name" class="block text-sm font-medium text-gray-400 mb-2 uppercase tracking-wide">Full
                    Name</label>
            ...
            <div>
                <label for="email" class="block text-sm font-medium text-gray-400 mb-2 uppercase tracking-wide">Email
                    Address</label>
            ...
            <div>
                <label for="goal" class="block text-sm font-medium text-gray-400 mb-2 uppercase tracking-wide">Primary
                    Goal</label>
                <div class="relative">
